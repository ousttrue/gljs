...
pub fn build(b: *Build) !void {
    ...
    if (target.result.isWasm()) {
        try buildWasm(b, "gljs", mod_main, dep_sokol, dep_cimgui);
    } else {
        try buildNative(b, "gljs", mod_main);
    }
}

fn buildNative(b: *Build, name: []const u8, mod: *Build.Module) !void {
...
fn buildWasm(b: *Build, name: []const u8, mod: *Build.Module, dep_sokol: *Dependency, dep_cimgui: *Dependency) !void {
